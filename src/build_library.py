...
def _render_html(entries: list, all_themes: list) -> str:
    ...
    a('          <a href="index.html" style="font-size:13px; color:#6b7280; text-decoration:none;">Feed</a>')
    ...
    a('        <p style="margin:0;"><a href="index.html" style="color:#2b4a8b; text-decoration:none;">News feed</a> · <a href="sources.html" style="color:#2b4a8b; text-decoration:none;">Sources</a> · <a href="feed.xml" style="color:#2b4a8b; text-decoration:none;">RSS feed</a></p>')
    a('      </div>')
    a('    </footer>')
    a('  </div>')
    ...
    a('            html += \'<span style="font-size:11.5px; padding:2px 9px; border-radius:999px; background:#e9eef7; color:#2b4a8b; border:1px solid #cdd7ea; font-weight:500;">\' + esc(t) + \'</span>\';')
    a('          });')
    a('          html += "</div>";')
    a('        }')
    a('        html += "</li>";')
